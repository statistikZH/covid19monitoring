...
Die Daten können unter folgendem Link als CSV und JSON bezogen werden: <br>
https://www.web.statistik.zh.ch/covid19_indikatoren_uebersicht/#/

In dieser Visualisierung kann der zeitliche Verlauf der einzelnen Indikatoren betrachtet werden:  <br>
